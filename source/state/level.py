...
class Level:
    ...
    def setup_checkpoint(self):
        ...
        for item in self.map_data['checkpoint']:
            ...
            checkponit_type = item['type']
            enemy_grounpid = item.get('enemy_groupid')
            self.checkpoint_group.add(stuff.Checkpoint(x, y, w, h, checkponit_type, enemy_grounpid))
    ...
    def if_frozen(self):
        return self.player.state in ['small_to_big', 'big_to_small']
    ...
    def check_x_collisions(self):
        ...
        power_up = pygame.sprite.spritecollideany(self.player, self.powerup_group)
        if power_up:
            power_up.kill()
            if power_up.name == 'mushroom':
    ...
    def check_y_collisions(self):
        ...
        elif brick:                                         # TODO try to use if instead of elif
    ...
    def adjust_player_y(self, sprite):
        if self.player.rect.bottom < sprite.rect.bottom:
            ...
            self.player.y_vel = 7 # -self.player.y_vel  TODO In the video, this speed is 7
    ...
    def check_will_fall(self, sprite):
        ...
        if not collided and sprite.state != 'jump' and not self.if_frozen():
            sprite.state = 'fall'
        sprite.rect.y -= 1
